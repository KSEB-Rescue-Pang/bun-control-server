...
('TOTE-101', 'IB', 1, 2, 'A01-R01-T', '완료', 1, '1237', '2025-07-31 10:30:00'),
('TOTE-101', 'IB', 11, 3, 'A01-R03-T', '완료', 2, '1237', '2025-07-31 10:35:00'),
('TOTE-101', 'IB', 13, 2, 'A02-R03-T', '완료', 3, '1237', '2025-07-31 10:40:00'),
('TOTE-101', 'IB', 15, 1, 'A03-R03-T', '완료', 4, '1237', '2025-07-31 10:45:00'),

-- 토트 TOTE-102: 탄산음료 3개, 컵라면 4개, 두유 2개, 휴지 3개 (IB 작업자: 윤지호)
('TOTE-102', 'IB', 2, 3, 'A01-R02-T', '완료', 1, '1238', '2025-08-01 14:20:00'),
('TOTE-102', 'IB', 3, 4, 'A02-R01-T', '완료', 2, '1238', '2025-08-01 14:25:00'),
('TOTE-102', 'IB', 4, 2, 'A02-R02-T', '완료', 3, '1238', '2025-08-01 14:30:00'),
('TOTE-102', 'IB', 9, 3, 'A05-R01-T', '완료', 4, '1238', '2025-08-01 14:35:00'),

-- 토트 TOTE-103: 전기포트 2개, 페브리즈 2개, 보조배터리 2개, 마스크팩 3개 (IB 작업자: 서지은)
('TOTE-103', 'IB', 5, 2, 'A03-R01-T', '완료', 1, '1239', '2025-08-02 09:15:00'),
('TOTE-103', 'IB', 12, 2, 'A01-R03-B', '완료', 2, '1239', '2025-08-02 09:20:00'),
('TOTE-103', 'IB', 14, 2, 'A02-R03-B', '완료', 3, '1239', '2025-08-02 09:25:00'),
('TOTE-103', 'IB', 20, 3, 'A05-R03-B', '완료', 4, '1239', '2025-08-02 09:30:00'),

-- 토트 TOTE-104: 무선청소기 1개, 선풍기 2개, 세제 2개, 물티슈 3개 (IB 작업자: 오세훈)
('TOTE-104', 'IB', 6, 1, 'A03-R02-T', '완료', 1, '1240', '2025-08-03 16:45:00'),
('TOTE-104', 'IB', 7, 2, 'A04-R01-T', '완료', 2, '1240', '2025-08-03 16:50:00'),
('TOTE-104', 'IB', 10, 2, 'A05-R02-T', '완료', 3, '1240', '2025-08-03 16:55:00'),
('TOTE-104', 'IB', 13, 3, 'A02-R03-T', '완료', 4, '1240', '2025-08-03 17:00:00'),

-- 토트 TOTE-105: 전기장판 2개, 세탁세제 3개, 무선마우스 2개, 비타민 2개 (IB 작업자: 정다인)
('TOTE-105', 'IB', 8, 2, 'A04-R02-T', '완료', 1, '1241', '2025-08-04 11:30:00'),
('TOTE-105', 'IB', 11, 3, 'A01-R03-T', '완료', 2, '1241', '2025-08-04 11:35:00'),
('TOTE-105', 'IB', 16, 2, 'A03-R03-B', '완료', 3, '1241', '2025-08-04 11:40:00'),
('TOTE-105', 'IB', 18, 2, 'A04-R03-B', '완료', 4, '1241', '2025-08-04 11:45:00'),

-- 토트 TOTE-106: 선풍기 1개, 세탁세제 2개, 보조배터리 2개, 손선풍기 2개 (IB 작업자: 장보라)
('TOTE-106', 'IB', 7, 1, 'A04-R01-T', '완료', 1, '1237', '2025-08-05 09:15:00'),
('TOTE-106', 'IB', 11, 2, 'A01-R03-T', '완료', 2, '1237', '2025-08-05 09:20:00'),
('TOTE-106', 'IB', 14, 2, 'A02-R03-B', '완료', 3, '1237', '2025-08-05 09:25:00'),
('TOTE-106', 'IB', 15, 2, 'A03-R03-T', '완료', 4, '1237', '2025-08-05 09:30:00'),

-- 토트 TOTE-107: 무선청소기 2개, 페브리즈 2개, 물티슈 2개, 샴푸 1개 (IB 작업자: 윤지호)  
('TOTE-107', 'IB', 6, 2, 'A03-R02-T', '완료', 1, '1238', '2025-08-05 14:25:00'),
('TOTE-107', 'IB', 12, 2, 'A01-R03-B', '완료', 2, '1238', '2025-08-05 14:30:00'),
('TOTE-107', 'IB', 13, 2, 'A02-R03-T', '완료', 3, '1238', '2025-08-05 14:35:00'),
('TOTE-107', 'IB', 19, 1, 'A05-R03-T', '완료', 4, '1238', '2025-08-05 14:40:00'),

-- 토트 TOTE-108: 무선마우스 2개, 비타민 3개, 마스크팩 2개, 손선풍기 2개 (IB 작업자: 서지은)
('TOTE-108', 'IB', 16, 2, 'A03-R03-B', '완료', 1, '1239', '2025-08-05 16:40:00'),
('TOTE-108', 'IB', 18, 3, 'A04-R03-B', '완료', 2, '1239', '2025-08-05 16:45:00'),
('TOTE-108', 'IB', 20, 2, 'A05-R03-B', '완료', 3, '1239', '2025-08-05 16:50:00'),
('TOTE-108', 'IB', 15, 2, 'A03-R03-T', '완료', 4, '1239', '2025-08-05 16:55:00'),
